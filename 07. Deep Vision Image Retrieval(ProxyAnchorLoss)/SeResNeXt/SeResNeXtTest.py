...
class SeResNeXtModel(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.model = timm.create_model('seresnext101_32x4d', pretrained=True)
        self.embedding_size = self.model.fc.in_features  # Access the embedding size from the last layer
        self.model.fc = nn.Identity()  # Remove the last fully connected layer
        self.name = 'seresnext101_32x4d'  # Add the name attribute
...
if __name__ == '__main__':
    ...
    batch_size = 32
    model_pattern = "best_model_seresnext101_32x4d_fold_*.pth"
