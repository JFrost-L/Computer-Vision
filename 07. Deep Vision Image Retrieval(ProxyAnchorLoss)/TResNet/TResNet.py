...
class TResNet(nn.Module):
    def __init__(self, num_classes=10, embedding_dim=128):
        ...
        self.model = timm.create_model('tresnet_l', pretrained=True)
        
        # TResNet 모델의 마지막 레이어 수정
        in_features = self.model.head.fc.in_features
        self.model.head.fc = nn.Linear(in_features, embedding_dim)
        
        self.embedding_size = embedding_dim  # Add the embedding_size attribute
        self.name = 'tresnet_l'  # Add the name attribute
