...
class InceptionV4Model(nn.Module):
    def __init__(self, num_classes=10):
        ...
        # Check the structure of the model to find the appropriate attribute for feature extraction
        self.embedding_size = self.model.last_linear.in_features
        self.model.last_linear = nn.Identity()  # Remove the classifier layer to get embeddings
        self.fc = nn.Linear(self.embedding_size, num_classes)
        self.name = 'InceptionV4'  # Add the name attribute
